...
class Executor:
    ...
    def is_ready_to_go(self, vm_context: VMContext, vm_context_list: dict[VMContext]) -> StartStatus:
    ...
    def get_vms_to_start(self, start_options: [VMLaunchSettings], px_vms: dict[int, VirtualMachine]) -> dict[int, VMContext]:
        """
