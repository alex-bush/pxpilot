...
__all__ = ["Message", "Notifier", "TelegramNotifier", "notifier_types", "NotificationManager"]
...
class NotificationManager:
    ...
    def append_status(self, type, id, name, status, start_time, duration: timedelta):
        if status == "started":
        ...
        msg = f"{self._digits[self._status_count]} *{type} {id} ({name})*:\n"
